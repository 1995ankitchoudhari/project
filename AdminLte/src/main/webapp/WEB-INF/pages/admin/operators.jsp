...
<%@page import="com.jbk.hibernate.Operator"%>
...
<%
     ArrayList<Operator> al=(ArrayList<Operator>)request.getAttribute("list");
%>
        <!-- Main content -->
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <thead>
                      ...
                      <th>Person</th>
                      <th>For</th>
                      <th>PreferedWaytoConnect</th>
                      <th>Timings</th>
                    </tr>
                    
                    <%
										
										for (Operator name:al) {
										
									
										
									%>
									<c:forEach var="operators" items="${list}">
									<tr>
									<td><% out.println(name.getId()); %></td>
									<td><% out.println(name.getPerson()); %></td>
									<td><% out.println(name.getFor_()); %></td>
									
									<td>
									
									<c:choose>
													<c:when test="${operators.getWhatsupp() eq 'true'}">
										...
										<td><% out.println(name.getTimeing());%></td>
							</tr>		
