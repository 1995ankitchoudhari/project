      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <c:forEach var="user" items="${user}" >
                <!-- form start -->
                <form class="form-horizontal" action="updateData" method="post"> 
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-3 control-label">Username</label>
                      <div class="col-sm-4">
                        <input class="form-control" value="<c:out value='${user.getUsername()}'/>" required id="username" placeholder="Username" type="text" name="username">
                      </div>
                    </div>                    
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Mobile</label>
                      <div class="col-sm-4">
                        <input class="form-control" value="<c:out value='${user.getMobile()}'/>" required id="mobile" placeholder="Mobile" type="number" name="mobile">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Email</label>
                      <div class="col-sm-4">
                        <input class="form-control" value="<c:out value='${user.getEmail()}'/>" required id="email" placeholder="Email" type="email" name="email">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="course" value="<c:out value='${user.getCourse()}'/>"  placeholder="Java/J2EE" type="text" name="course">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4" style="margin-top:6px;">
                        ...
                        <input name="gender" required id="Male" value="<c:out value='${user.getGender()}'/>" type="radio" style="margin-right:2px;" name="gender"> Male
                        <input name="gender" required id="Female" value="<c:out value='${user.getGender()}'/>"  type="radio" style="margin-right:2px;margin-left:10px;" name="gender"> Female
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4" style="margin-top:6px;">
                        ...
                        <input name="isdefault" required id="yes" value="yes"   type="radio" style="margin-right:2px;" >yes
                        <input name="isdefault" required id="no" value="no"  type="radio" style="margin-right:2px;margin-left:10px;">no
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                         ...
                         <option value="">--Select State--</option> 
                          <c:forEach items="${stateList}" var="country">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="password" value="<c:out value='${user.getPassword()}'/>" placeholder="Password" type="password" name="password">
