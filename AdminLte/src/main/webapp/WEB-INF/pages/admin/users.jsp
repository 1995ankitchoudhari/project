				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<tr>
											...
											<td class="text-center"><% out.println(name.getCountry().getState()); %></td>
							...
							<a href="/multipleDelete"><button type="submit" class="btn btn-primary btn-block btn-flat" 
								style="width: 100px;" onclick="if(!(confirm('Are You Sure To Delete'))) return false">Delete</button></a>
