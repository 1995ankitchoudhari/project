      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview"><a href="/downloadslink"">
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td>01</td>
                      <td><img src="/images/jdk.png" alt="JBK Download" style="height: 40px; padding-left: 7px;"></td>  
                    ...
                    <tr>
                      <td>02</td>
                      <td><img src="/images/selenium.png" alt="JBK Download" style="height: 40px"></td>  
                    ...
                    <tr>
                      <td>04</td>
                      <td><img src="/images/chrome.png" alt="JBK Download" style="height: 40px"></td>  
                      <td>Google Chrome </td>
                    ...
                    <tr>
                      <td>06</td>
                      <td><img src="/images/firefox.png" alt="JBK Download" style="height: 40px"></td>  
